  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col">
        ...
        <form
          id="settings"
          className="divede-zinc-500 mt-6 flex w-full flex-col gap-5 divide-y"
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Joyce" />
              </Input.Root>
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Fatima" />
              </Input.Root>
            </div>
          </div>
